...
parser.add_argument("--input_filename",
                    ...
                    default=os.path.join(settings.OUT_PATH, "unet_model_transposed.hdf5"))
parser.add_argument("--output_directory",
                    help="Directory where to save the TensorFlow Serving Protobuf Model",
               	    default="saved_model_pb")
...
"""
model = keras.models.load_model(args.input_filename, custom_objects={"dice_coef":dice_coef, "dice_coef_loss":dice_coef_loss})
