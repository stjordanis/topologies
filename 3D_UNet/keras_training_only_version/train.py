...
def get_file_list(data_path=args.data_path):
	...
	train_length = int(args.train_test_split*n)
...
def get_batch(fileList, batch_size=args.bz):
	...
	imgs = np.zeros((batch_size, args.patch_dim, args.patch_dim, args.patch_dim, 1))
	msks = np.zeros((batch_size, args.patch_dim, args.patch_dim, args.patch_dim, 1))
