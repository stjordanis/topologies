...
# Replace with your BraTS data directory
root_dir = '/home/bduser/data_test/MICCAI_BraTS17_Data_Training'
# Final dimension (square), set resize = 240 (original dimension) if no resizing is desired
resize = 128
...
def resize_data(dataset, new_size):
    ...
    if rotate != 0:
        resized = np.rot90(
            dataset[:, start_index:end_index, start_index:end_index:], rotate, axes=(1, 2))
    else:
